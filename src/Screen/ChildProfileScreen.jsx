  ...
  return (
    <SafeAreaView style={[s.container, { backgroundColor: theme.bg }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={s.hero}>
          ...
          <View style={[s.levelBadge, { backgroundColor: theme.accent }]}>
            <Text style={s.levelBadgeTxt}>Level {level}</Text>
          </View>
        ...
        <View style={[s.xpCard, { backgroundColor: theme.white, borderColor: theme.border }]}>
          ...
          <View style={[s.xpBg, { backgroundColor: theme.bg, borderColor: theme.border }]}>
            <View style={[s.xpFill, { backgroundColor: theme.accent, width: `${Math.min(xpProgress, 100)}%` }]} />
          </View>
      ...
      <View style={[s.nav, { backgroundColor: theme.white, borderTopColor: theme.border }]}>
        {NAV_ITEMS.map(n => {
          const active = n.sc === 'ChildProfile';
          return (
